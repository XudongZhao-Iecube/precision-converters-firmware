...
## Checking out the project repository into local drive
Run below command to checkout the git repository and all dependancy (submodules):
...
By default, the STM32CubeIDE generates the Makefile automatically which is used to build/compile the project.
