...
/* Select the polarity for thermistor config */
#define BIPOLAR		// comment to select unipolar mode

/* Select filter type for thermistor config */
...
/* Select the PGA for thermistor config */
#define AD4170_PGA_CONFIG				AD4170_PGA_GAIN_1_PRECHARGE
