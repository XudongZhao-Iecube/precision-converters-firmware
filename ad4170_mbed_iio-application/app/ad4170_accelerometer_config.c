		...
		.setups = {
			{
				...
				.afe = {
					...
					.ref_select = AD4170_REFIN_AVDD, .bipolar = AD4170_BIPOLAR_MODE, .pga_gain = AD4170_PGA_CONFIG
				},
				.filter = {.post_filter_sel = AD4170_POST_FILTER_NONE, .filter_type = AD4170_FILTER_CONFIG },
				.filter_fs = AD4170_FS_CONFIG, .offset = AD4170_ACCELEROMETER_CONFIG_OFFSET_RESET_VAL, .gain = AD4170_ACCELEROMETER_CONFIG_GAIN_RESET_VAL,
			},
		},
